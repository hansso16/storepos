    ...
    public partial class formInvoiceReceipt : Form
    {
        ...
        public void LoadReport(string RefNo)
        {
            ...
            try
            {
                ...
                sda.SelectCommand = new SqlCommand("select i.InvoiceId id, i.ReferenceNo refno, p.pcode, pd.price, id.Qty qty, u.type uom , i.EntryTimestamp date, id.TotalItemPrice total " +
